...
#include "../../../src/shared/FileLogger.h"
...
QT_MOC_LITERAL(1, 11, 14), // "rollingLogFile"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "newFilename"

    },
    "FileLogger\0rollingLogFile\0\0newFilename"
};
...
void FileLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rollingLogFile((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FileLogger::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileLogger::rollingLogFile)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FileLogger::staticMetaObject = {
    { &AbstractLoggerInterface::staticMetaObject, qt_meta_stringdata_FileLogger.data,
...
void *FileLogger::qt_metacast(const char *_clname)
{
    ...
    return AbstractLoggerInterface::qt_metacast(_clname);
}

int FileLogger::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AbstractLoggerInterface::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
...
// SIGNAL 0
void FileLogger::rollingLogFile(QString _t1)
{
