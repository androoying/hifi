...
void main()
{
    ...
    float _1205 = mix(0.00999999977648258209228515625, 1.0, max(0.0, 0.921875));
    float _1211 = _1205 * _1205;
    float _1217 = _1211 * _1211;
    float _1222 = clamp(dot(_944, _1086), 0.0, 1.0);
    float _1243 = 1.0 - _1217;
    vec4 _1271 = _374.lightAmbient.transform * vec4(_944, 0.0);
    vec3 _1350 = max(vec3(1.0 - _1205), vec3(0.0)) * pow(1.0 - _1222, 5.0);
    float _1291 = 1.0 - length(vec3(0.100000001490116119384765625));
    float _1363 = _1271.x;
    float _1368 = _1271.y;
    float _1378 = _1271.z;
    vec3 _1304 = -reflect((_374.lightAmbient.transform * vec4(_1086, 0.0)).xyz, _1271.xyz);
    vec3 _1321 = mix(vec3(1.0), _color.xyz, vec3(_319.lightingModel._ScatteringDiffuseSpecularAlbedo.w));
    ...
    vec3 _1954 = _1967;
    _1954.x = dot(_944, _1543);
    vec3 _1956 = _1954;
    _1956.y = dot(_944, _1512);
    vec3 _1958 = _1956;
    ...
    float _1621 = (_1291 * _1569) * (1.0 - _1642);
