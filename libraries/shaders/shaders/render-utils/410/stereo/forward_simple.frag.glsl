...
void main()
{
    ...
    float _1210 = mix(0.00999999977648258209228515625, 1.0, max(0.0, 0.921875));
    float _1216 = _1210 * _1210;
    float _1222 = _1216 * _1216;
    float _1227 = clamp(dot(_948, _1091), 0.0, 1.0);
    float _1248 = 1.0 - _1222;
    vec4 _1276 = _374.lightAmbient.transform * vec4(_948, 0.0);
    vec3 _1355 = max(vec3(1.0 - _1210), vec3(0.0)) * pow(1.0 - _1227, 5.0);
    float _1296 = 1.0 - length(vec3(0.100000001490116119384765625));
    float _1368 = _1276.x;
    float _1373 = _1276.y;
    float _1383 = _1276.z;
    vec3 _1309 = -reflect((_374.lightAmbient.transform * vec4(_1091, 0.0)).xyz, _1276.xyz);
    vec3 _1326 = mix(vec3(1.0), _color.xyz, vec3(_319.lightingModel._ScatteringDiffuseSpecularAlbedo.w));
    ...
    vec3 _1959 = _1972;
    _1959.x = dot(_948, _1548);
    vec3 _1961 = _1959;
    _1961.y = dot(_948, _1517);
    vec3 _1963 = _1961;
    ...
    float _1626 = (_1296 * _1574) * (1.0 - _1647);
