...
void main()
{
    ...
    {
        vec2 _245 = ((varTexCoord0 * _50.parameters.texcoordTransform.zw) + _50.parameters.texcoordTransform.xy) + (((vec2(1.0, 0.0) * _50.parameters.filterInfo.x) * _50.parameters.resolutionInfo.zw) * _50.parameters.taps[_317].x);
