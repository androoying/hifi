...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Assignment_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Assignment_t qt_meta_stringdata_Assignment = {
    {
QT_MOC_LITERAL(0, 0, 10) // "Assignment"
...
QT_INIT_METAOBJECT const QMetaObject Assignment::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Assignment.data,
      qt_meta_data_Assignment,  qt_static_metacall, nullptr, nullptr}
};
...
void *Assignment::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Assignment.stringdata0))
