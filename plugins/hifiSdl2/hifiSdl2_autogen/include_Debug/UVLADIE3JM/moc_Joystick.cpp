...
QT_MOC_LITERAL(2, 14, 10) // "instanceId"

    },
    "Joystick\0name\0instanceId"
};
...
void Joystick::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast< int*>(_v) = _t->getInstanceId(); break;
        default: break;
        }
...
void *Joystick::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "controller::InputDevice"))
        return static_cast< controller::InputDevice*>(this);
